...
import { backgroundAnsiAtColumn, PointerInteractionController } from "@luan.sh/pi-libtui";
import type { MouseRect, TuiMouseEvent, ViewportRect } from "@luan.sh/pi-libtui/mouse";
