...
import { configureTuiAppearance, DEFAULT_TUI_APPEARANCE, icon, tuiTheme } from "@luan.sh/pi-libtui";
import type { TuiMouseEvent } from "@luan.sh/pi-libtui/mouse";
import { serializeEnvelope } from "../../src/annotations/core/envelope.ts";
import { plainPill } from "../../src/annotations/core/pills.ts";
import { AnnotationPresentationGroups } from "../../src/annotations/core/presentation.ts";
import { AnnotationStore } from "../../src/annotations/core/store.ts";
import type { ResponseAnnotation } from "../../src/annotations/core/types.ts";
import { renderAnnotationMarker, stripAnnotationMarker } from "../../src/annotations/ui/annotation-markers.ts";
import { renderPill } from "../../src/annotations/ui/pills.ts";
import { handleReferencePillMouse, ReferencePillController } from "../../src/annotations/ui/reference-pills.ts";
