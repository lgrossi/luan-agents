...
![pi-libactions in Bootty](https://github.com/luan/agents/releases/download/v0.3.1/pi-libactions.png)

[Watch the demo](https://github.com/luan/agents/releases/download/v0.3.1/pi-libactions.mp4).
