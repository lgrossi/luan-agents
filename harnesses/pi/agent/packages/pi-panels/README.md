...
![pi-panels in Bootty](https://github.com/luan/agents/releases/download/v0.3.0/pi-panels.png)

[Watch the demo](https://github.com/luan/agents/releases/download/v0.3.0/pi-panels.mp4).
