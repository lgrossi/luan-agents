...
![pi-tool-search in Bootty](https://github.com/luan/agents/releases/download/v0.3.1/pi-tool-search.png)

[Watch the demo](https://github.com/luan/agents/releases/download/v0.3.1/pi-tool-search.mp4).
