...
- The root Cargo workspace owns the Rust bridge at `crates/terminal-bridge`; `pi-libtui` owns its client, discovery, and first-use build.
- `PI_TERMINAL_BRIDGE_BINARY` provides the test override.
